...
export function TopBar({
  ...
  return (
    <header className="sticky top-0 z-30 border-b border-[#d4c7b4] bg-[#fbf7ef]/92 px-4 py-3 backdrop-blur lg:px-6">
      <div className="mx-auto grid max-w-7xl gap-3 lg:grid-cols-[1fr_minmax(360px,520px)] lg:items-center">
        <div className="min-w-0">
          ...
          <h1 className="mt-1 text-balance text-2xl font-black leading-none text-[#171714] sm:text-3xl">
            Xray 节点切换台
          </h1>
        </div>
        ...
        <div className="grid gap-2">
          ...
          <div
            aria-live="polite"
            className={`line-clamp-2 rounded-md border px-3 py-2 text-xs ${toastClassName(toast.tone)}`}
            role="status"
          >
            {toast.message}
          </div>
